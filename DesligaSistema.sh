...
#
# CHANGELOG :
#   29/07/2020 11:00  -Criado Script de desligamento
#     -Função adicionado para aproeitamento de código
#   03/08/2020 18:00 -Ajustado script corrigindo erro ao cancelar agendamento
#     -Adicionado segurança para evitar inserção de nao numeros
#   01/10/2020 21:00 -Ajustes de sintaxe
#-----------FIM-HEADER---------------------------------------------------------|
